/* This C++ source code of a DSatur-based backtracking algorithm for graph colouring has been adapted from the 
	...
	* Other optional command line settings can be viewed by running the programm from the 
...
void colorsearch(char *name, int targetnumcolors)
{
	...
	//If the branching factor is set very large, and no backtrack region is excluded (see below) then this 
...
int main(int argc, char *argv[]) {
	...
	if (timeStream.fail() || checksStream.fail()){cout << "ERROR OPENING output FILE";exit(1);}
