...
void sortGroupsDesending(vector< vector<int> > &A);
void sortGroupsAscending(vector< vector<int> > &A);
...
void greedyCol(vector< vector<int> > &oldSol, vector<int> &colNode);
...
void force(vector< vector<int> > &U, vector< vector<int> > &candSol, int groupToConsider);
...
void selectAnItemAtRandom(vector< vector<int> > &candSol, int &r, int &c);
